...
def linebot():
    ...
    try:
        ...
        if tp == "text":
            with open('https://steam.oxxostudio.tw/download/python/line-rich-menu-demo.jpg', 'rb') as f:
                line_bot_api.set_rich_menu_image('richmenu-b04102d54c3ba22bada7e26fe26215b1', 'image/jpeg', f)
